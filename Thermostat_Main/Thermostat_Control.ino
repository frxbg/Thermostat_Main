...
// settings
  ...
  #define _LCDML_CONTROL_analog_enter_min        560     // Button Enter
  #define _LCDML_CONTROL_analog_enter_max        790  
  #define _LCDML_CONTROL_analog_up_min           60     // Button Up
  #define _LCDML_CONTROL_analog_up_max           195   
  #define _LCDML_CONTROL_analog_down_min         200     // Button Down
  #define _LCDML_CONTROL_analog_down_max         380   
  #define _LCDML_CONTROL_analog_back_min         390     // Button Back
  #define _LCDML_CONTROL_analog_back_max         555   
  #define _LCDML_CONTROL_analog_left_min         0     // Button Left
  #define _LCDML_CONTROL_analog_left_max         0   
  #define _LCDML_CONTROL_analog_right_min        0     // Button Right
  #define _LCDML_CONTROL_analog_right_max        0
// *********************************************************************
// setup
void LCDML_CONTROL_setup()
{
